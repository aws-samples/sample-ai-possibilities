...
layout: snippet
language: python
description: "07 - Programmatic Tool Calling with AgentCore Code Interpreter
...
source_file: "snippets/migration-from-code-execution-tool-to-agentcore-code-interpreter/07_programmatic_tool_calling.py"
---
...
<div class='source-links'>
  <a href='https://github.com/aws-samples/sample-ai-possibilities/blob/main/snippets/migration-from-code-execution-tool-to-agentcore-code-interpreter/07_programmatic_tool_calling.py' class='btn btn-primary'>
    View Raw File
  </a>
</div>
