...
The complete dataset is approximately 600GB in size. You can use the provided `download.py` script to download a subset of videos (it will download 25 videos as default).

#### Authentication Steps
1. Install the Hugging Face CLI: `pip install huggingface_hub`
2. Login via CLI: `hf auth login`
...
4. Python `download.py` script requires `datasets` python package
