...
An AI-powered conversational agent that provides natural language access to your video library. Built with AWS Strands SDK and Amazon Nova Omni, this agent serves as an intelligent interface for video search, analysis, and discovery.

## Features

### 🤖 Conversational AI Interface
- **Natural Language Processing**: Powered by Amazon Nova Omni via Amazon Bedrock
...
# AI Model Configuration (Nova Omni for video-aware responses)
BEDROCK_MODEL_ID=global.amazon.nova-2-omni-v1:0
