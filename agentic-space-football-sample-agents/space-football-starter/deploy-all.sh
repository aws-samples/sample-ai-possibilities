...
# ============================================================================
# Deploy all 5 Space Football ship agents to Bedrock AgentCore
# ============================================================================
#
# Usage:
#   AWS_PROFILE=your-profile ./deploy-all.sh          # deploy all
#   AWS_PROFILE=your-profile ./deploy-all.sh ship-keeper    # deploy one agent
#
# How it works:
...
ALL_AGENTS=("ship-keeper" "ship-sweeper" "ship-support" "ship-runner" "ship-striker")
...
echo "=========================================="
echo "  Space Football — Deploy Ship Agents"
echo "=========================================="
echo ""
